...
吉祥Ai短剧是一个基于 AI 的短剧自动化生产平台，实现从剧本生成、角色设计、分镜制作到视频合成的全流程自动化。
...
| 平台 | 下载文件 |
|---|---|
| macOS（Apple Silicon，M 系列） | `JixiangAiShortDrama-4.0.4-arm64.dmg` |
...
<div align="center">
  <img src="docs/images/jixiang-logo-green.png" alt="吉祥 Ai 短剧绿色标志" width="240" />
</div>
...
<div align="center">
  <img src="docs/images/jixiang-logo-white.png" width="240" alt="吉祥 Ai 短剧浅色标志" />
</div>
