...
export const episodes = sqliteTable('episodes', {
  ...
  breakdownMode: text('breakdown_mode').default('auto'),
  targetDuration: integer('target_duration').default(165),
  targetStoryboardCount: integer('target_storyboard_count').default(0),
