...
app.post('/:id/generate-image', async (c) => {
  ...
  try {
    ...
    const genId = await generateImage({ sceneId: id, dramaId: scene.dramaId, prompt, model: body.model, resolution: body.resolution, configId: body.config_id ?? ep.imageConfigId ?? undefined })
